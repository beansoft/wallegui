 ...
 * @author <a href="mailto:beansoft@126.com">LiuChangjiong</a>
 */
public class OSXSupport {
     ...
     * @param fullScreenableWindow the window that should be full screen enabled, could be null
     */
    public static void initializeMacOSX(Action aboutAction,
        ...
        try {
            ...
            if (isOSXNewEAWT()) {
                ...
                if (fullScreenableWindow != null && hasOSXFullScreenSupport()) {
    ...
    public static void setDockIconBadge(String badge) {
        try {
            ...
            Object application = getOSXApplication();
            Method setDockIconBadgeMethod = application.getClass().getMethod("setDockIconBadge", String.class);
            setDockIconBadgeMethod.invoke(application, badge);
